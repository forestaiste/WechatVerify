package com.forest.wechat.main;

import com.forest.wechat.menu.*;
import com.forest.wechat.pojo.Token;
import com.forest.wechat.util.CommonUtil;
import com.forest.wechat.util.MenuUtil;
...
public class MenuManager {
    ...
    public static void main(String[] args) {
        // 第三方用户唯一凭证
        String appId = "wx9b67a1845cda4a36";
        // 第三方用户唯一凭证密钥
        String appSecret = "eca1e8b9a0bce6d4e00d7142b931bb52";
