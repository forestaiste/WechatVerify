...
import com.forest.wechat.message.resp.Music;
import com.forest.wechat.pojo.*;
...
public class AdvancedUtil {
    ...
    public static void main(String args[]) {
        // 获取接口访问凭证
        String accessToken = CommonUtil.getToken("wx9b67a1845cda4a36", "eca1e8b9a0bce6d4e00d7142b931bb52").getAccessToken();

        /**
         * 发送客服消息（文本消息）
         */
        // 组装文本客服消息
        String jsonTextMsg = makeTextCustomMessage("oIOvswVKM2DN92_YMs636D3lVrzc", "点击查看<a href=\"http://blog.csdn.net/lyq8479\">柳峰的博客</a>");
        // 发送客服消息
        ...
        list.add(article2);
        // 组装图文客服消息
        String jsonNewsMsg = makeNewsCustomMessage("oIOvswVKM2DN92_YMs636D3lVrzc", list);
        // 发送客服消息
         ...
         * 获取用户信息
         */
        WeixinUserInfo user = getUserInfo(accessToken, "oIOvswVKM2DN92_YMs636D3lVrzc");
         ...
         * 下载多媒体文件哦
         */
        getMedia(accessToken, "N7xWhOGYSLWUMPzVcGnxKFbhXeD_lLT5sXxyxDGEsCzWIB2CcUijSeQOYjWLMpcn", "e:/download");
    }
}
