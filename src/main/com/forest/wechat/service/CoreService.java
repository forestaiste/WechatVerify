        ...
        try {
            ...
            if (msgType.equals(MessageUtil.REQ_MESSAGE_TYPE_EVENT)) {
                ...
                if (eventType.equals(MessageUtil.EVENT_TYPE_SUBSCRIBE)) {
                    textResponse.setContent("您好，欢迎关注网址导航！我们致力于打造精品网址聚合应用，为用户提供便捷的上网导航服务。体验生活，从这里开始！");
                    // 将消息对象转换成xml
                ...
                // 自定义菜单点击事件
                    ...
                    if (eventKey.equals("oschina")) {
                        ...
                        textResponse.setContent("ITeye即创办于2003年9月的JavaEye,从最初的以讨论Java技术为主的技术论坛，已经逐渐发展成为涵盖整个软件开发领域的综合性网站。\n\nhttp://www.iteye.com");
                        respXml = MessageUtil.messageToXml(textResponse);
                    }
                }
            }
            // 当用户发消息时
                ...
                textResponse.setContent("请通过菜单使用网址导航服务！");
                respXml = MessageUtil.messageToXml(textResponse);
            }
        } catch (Exception e) {
            e.printStackTrace();
